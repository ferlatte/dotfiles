(custom-set-variables
 ...
 '(package-selected-packages
   '(company-lsp flycheck-golangci-lint epl flx hl-todo json-reformat json-snatcher logito makey memoize pkg-info popup ggtags auto-package-update web-mode ghub toml-mode counsel swiper ivy pythonic flycheck-gometalinter marshal rich-minority cask-mode terraform-mode json-rpc editorconfig dockerfile-mode avy let-alist pcache company ido-completing-read+ gh auctex dash go-rename anaconda-mode async go-eldoc go-guru go-mode ht magit-popup yasnippet f git-commit helm helm-core macrostep projectile s with-editor zop-to-char zenburn-theme yari yaml-mode which-key volatile-highlights undo-tree solarized-theme smex smartrep smartparens smart-mode-line slime scss-mode ruby-tools rainbow-mode rainbow-delimiters ov operate-on-number move-text markdown-mode magit json-mode js2-mode inf-ruby imenu-anywhere ido-ubiquitous helm-projectile guru-mode grizzl gotest god-mode go-projectile gitignore-mode gitconfig-mode git-timemachine gist geiser flycheck flx-ido expand-region exec-path-from-shell elisp-slime-nav easy-kill discover-my-major diminish diff-hl csv-mode crux company-go company-auctex company-anaconda cdlatex browse-kill-ring beacon anzu ace-window))
